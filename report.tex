...
\newcommand{\hmwkTitle}{Rapport\ étude\ de\ 
...
\includegraphics{images/dfd.png}
...
\includegraphics{images/loop2.PNG}
...
\hypertarget{scuxe9nario-9-suppression-des-utilisateurs}{%
\subsubsection{Scénario 9 : Suppression des
utilisateurs}\label{scuxe9nario-9-suppression-des-utilisateurs}}
...
\includegraphics{images/users1.PNG}

Lorsque l'administrateur ouvre ce message, voici le résultat:

\includegraphics{images/users2.PNG}
...
\includegraphics{images/users3.PNG}
...
\hypertarget{scuxe9nario-10-ruxe9cupuxe9ration-des-mots-de-passe-uxe0-partir-des-hash}{%
\subsubsection{Scénario 10: Récupération des mots de passe à partir des
hash}\label{scuxe9nario-10-ruxe9cupuxe9ration-des-mots-de-passe-uxe0-partir-des-hash}}
...
\hypertarget{limiter-le-nombre-de-tentatives-de-login}{%
\subsubsection{Limiter le nombre de tentatives de
login}\label{limiter-le-nombre-de-tentatives-de-login}}
...
\includegraphics{images/tentative_db.PNG}
...
\includegraphics{images/tentative_model.PNG}
